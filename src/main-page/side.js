...
function getPreMadeContent() {
  ...
  content.innerHTML = /*javascript*/ `
    <button class="add-task side-item">
      <span class="icon">${addTaskIcon}</span><p>Add Task</p>
    </button>
    <button class="general side-item">
      <span class="icon">${generalIcon}</span><p>General</p>
    </button>
    <button class="today side-item">
      <span class="icon">${todayIcon}</span><p>Today</p>
    </button>
    `.trim()
  return content
}
...
function getUserMadeContent() {
  const content = document.createElement("div")
  content.innerHTML = /*javascript*/ `
   <h1 class="side-item side-header">Projects</h1>
   <button class="today side-item">
      <span class="icon">😀</span><p>Today</p>
    </button>
    `.trim()
  return content
}
